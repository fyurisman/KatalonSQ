...
public class SingleExcel {
	...
	def void writeToExcel(int iRow, int iCell, String iText ){
		...
		FileInputStream file = new FileInputStream (new File("C:\\Users\\Administrator\\Desktop\\KatalonResult.xlsx")) //edit excel location
		...
		FileOutputStream outFile =new FileOutputStream(new File("C:\\Users\\Administrator\\Desktop\\KatalonResult.xlsx")); //edit excel location
