...
WebUI.navigateToUrl('https://dev.sehatq.com/penyakit/mata/ablasi-retina')
...
for (int i = 0; i < 223; i++) {
    ...
    WebUI.verifyElementPresent(findTestObject('penyakit/Page_Ablasi Retina  Definisi gejala/a_Penyakit Selanjutnya'), 
        30)
