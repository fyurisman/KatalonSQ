...
WebUI.navigateToUrl(GlobalVariable.target+'sehatq.com/faskes/cari-faskes?qSpesialisasi=&qMedical=&qBpjs=&qSort=desc&qLat=&qLang=&qLoc=&qKec=&qProv=&keyword=mitra+keluarga&region=')
...
WebUI.waitForElementClickable(findTestObject('rumah sakit/sort drop down/a_A - Z'), 5)

WebUI.click(findTestObject('rumah sakit/sort drop down/a_A - Z'))
