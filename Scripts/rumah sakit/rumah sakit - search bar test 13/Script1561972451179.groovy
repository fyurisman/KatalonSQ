...
/**
 * test regency suggetion from location field in search bar
 * */
WebUI.navigateToUrl(GlobalVariable.target+'sehatq.com/faskes')

WebUI.waitForPageLoad(5, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('rumah sakit/searchbar_input_Cari Lokasi Faskes'), 'palmera')
...
WebUI.verifyElementPresent(findTestObject('rumah sakit/a_Palmerah'), 5)
