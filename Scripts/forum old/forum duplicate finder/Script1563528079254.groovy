...
true) {
    for (int i = 1; i < 11; i++) {
		...
		CustomKeywords.'writeToExcel.MultipleExcel.TargetExcel'('KR1',x, 1, WebUI.getUrl()) //url
		CustomKeywords.'writeToExcel.MultipleExcel.TargetExcel'('KR1',x, 2, WebUI.getText(findTestObject('forum/Page_Kepanasan saat hamil mengapa/p_question text'))) //content
        x++
