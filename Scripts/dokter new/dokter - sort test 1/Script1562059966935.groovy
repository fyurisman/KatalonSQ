...
WebUI.navigateToUrl(GlobalVariable.target+'sehatq.com/dokter/cari-dokter?keyword=bagus&region=')
...
WebUI.waitForElementClickable(findTestObject('dokter new/sort dropdown/a_Z -A'), 5)

WebUI.click(findTestObject('dokter new/sort dropdown/a_Z -A'))
