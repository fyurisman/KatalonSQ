...
b = '/html/body/div[4]/main/div[2]/div/div/div[1]/div/div/div/div/div[1]/form/div/div[2]/div[6]/button[1]'

TestObject button = new TestObject('button').addProperty('xpath', com.kms.katalon.core.testobject.ConditionType.EQUALS,
	b, true)
...
for (int i = 25; i < 33; i++) {
	...
	WebElement element = WebUiCommonHelper.findWebElement(button, 30)
