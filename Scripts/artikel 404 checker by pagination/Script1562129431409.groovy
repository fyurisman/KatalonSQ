...
WebUI.navigateToUrl(GlobalVariable.target+'sehatq.com/artikel?page=1')

WebUI.waitForPageLoad(5)

while (WebUI.verifyElementPresent(findTestObject('artikel/Page_LIVE/a_'), 0, FailureHandling.OPTIONAL) == true) {
    def uerel = []
	...
	WebUI.click(findTestObject('Object Repository/artikel/Page_LIVE/a_'))
	WebUI.waitForPageLoad(5)
}
